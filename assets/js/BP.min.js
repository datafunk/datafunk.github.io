...
/* kirbyUtils */
var BP=BP||{},console=window.console||{log:function(){},error:function(){},info:function(){}};BP.kirbyUtils=function(){var e=!1,r=function(){navigator.userAgent.match(/Android|BlackBerry|Mobile|iPhone|iPod|iPad|Opera Mini|IEMobile|PlayBook/i)?($("body").addClass("mobile"),e=!0):($("body").removeClass("mobile"),e=!1)}();return $(window).on("resize",r),$("a").each(function(){var e=new RegExp("/"+window.location.host+"/");e.test(this.href)||$(this).click(function(e){e.preventDefault(),e.stopPropagation(),window.open(this.href,"_blank")})}),{isMobile:e}},BP.email=function(){function e(e){var r=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return r.test(e)}function r(e){"sent"===e.status?($("#BP_email_response").removeClass("error"),$("#BP_email_response").html("Thank you. Your email has been sent.")):($("#BP_email_response").addClass("error"),$("#BP_email_response").html("Something went wrong. Your email has not been sent."))}function o(){var e=$("#BP_mail"),o=e.find("input, radio, textarea, button"),n=e.serialize();o.prop("disabled",!0);var s=$.ajax({url:a+"sendmail.php",type:"post",data:n,beforeSend:function(){return l()===!1||i()===!1?(console.error("missing info, terminating"),$("#BP_email_response").addClass("error"),$("#BP_email_response").html("Please fill out all fields marked with an * asterisk! "),!1):void 0}});s.done(function(e,o,n){r(e)}),s.fail(function(e,r,o){console.error("== error ==\n"),console.error(e,r,o),$("#BP_email_response").addClass("error"),$("#BP_email_response").html("Sorry, Something went wrong.")}),s.always(function(){o.prop("disabled",!1)})}var n="",a="/static/",i=function(){n=$("#semail").val();var r=!1;return""===n||e(n)===!1?($("#semail").addClass("error"),$($("label[for='semail']")[0]).addClass("error"),$($("label[for='semail']")[0]).html("Please provide a valid email address"),r=!1):($("#semail").removeClass("error"),$($("label[for='semail']")[0]).removeClass("error"),$($("label[for='semail']")[0]).html("Your email *"),r=!0),r},l=function(){var e=!1;return""===$("#sname").val()?($("#sname").addClass("error"),$($("label[for='sname']")[0]).addClass("error"),$($("label[for='sname']")[0]).html("Please let me know your name"),e=!1):($("#sname").removeClass("error"),$($("label[for='sname']")[0]).removeClass("error"),$($("label[for='sname']")[0]).html("Your name *"),e=!0),e};return $("#sname").on("blur",function(){l()}),$("#semail").on("blur",function(){i()}),$("#submit").on("click",function(e){e.preventDefault(),o()}),{nameMsg:l,emailMsg:i}},document.addEventListener("DOMContentLoaded",function(){BP.kirbyUtils(),-1!==window.location.href.indexOf("/contact")&&BP.email()},!1);
